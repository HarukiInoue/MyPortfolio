...
description: Turns a customer's backyard photo + address into an interactive design-and-quote package: a clean "before", multiple AI design concepts rendered from the same photo, best-guess measurements, a style-switching before/after hero, and a live-recalculating itemized quote with financing. Includes working code and the real-world integration points a landscaping company needs to run it in production.
source: https://github.com/alexmcdonnell-airtable/hyperagent-public-skills/blob/main/skill-landscaping-design-and-quote.json
---

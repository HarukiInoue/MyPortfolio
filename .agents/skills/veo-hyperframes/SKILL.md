...
description: End-to-end production pipeline for creating polished launch videos using Veo 3.1 video generation and Hyperframes motion graphics overlays. Built around the Text Zone Composition principle: every shot reserves a clear 1/3 of the frame as a contrast zone for legible text overlays. Covers beat board planning with declared text zones, cinematic contrast techniques, hero image generation, Veo prompt construction with zone preservation clauses, GSAP-animated typography overlays, and ffmpeg compositing via colorkey.
source: https://github.com/alexmcdonnell-airtable/hyperagent-public-skills/blob/main/skill-veo-hyperframes.json
---

...
description: Track your work as records on an Airtable Kanban board: one thread per record, flipping each record from an in-progress status to a ready-for-review status as you work, and creating new task records when asked. A general, reusable workflow for any base or table using the connected Airtable integration.
source: https://github.com/alexmcdonnell-airtable/hyperagent-public-skills/blob/main/skill-airtable-kanban-work-tracker.json
---

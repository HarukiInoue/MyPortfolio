...
description: A battle-tested methodology for running ANY business in real-time simulation as an autonomous operator agent on Hyperagent. Pick a venture — a shop, restaurant, SaaS product, boutique, fund, agency, nonprofit, or creator business — and the agent operates it day by day: calendar discipline, real-world grounding, source-of-truth locking, delegated authority, an operational tracker, a named persona team, finance honesty, risk/cadence management, and self-correction. Includes a Day-0 setup on-ramp and a configurable sim-clock script.
source: https://github.com/alexmcdonnell-airtable/hyperagent-public-skills/blob/main/skill-business-simulation-operator-method.json
---
